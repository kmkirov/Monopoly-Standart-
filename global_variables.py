...
list_of buildings = [ deck_building('GO',  'GO'         , 60,      50      ,2   ,10 ,     30 ,     90    ,  160  ,   250)
deck_building('Mediterranean Ave.',  'Purple'         , 60,      50      ,2   ,10 ,     30 ,     90    ,  160  ,   250),
deck_building('Baltic Ave.',         'Purple'         , 60 ,     50      ,4   ,20 ,     60  ,    180   ,  320  ,   450),
deck_building('Oriental Ave.',       'Light-Green'    , 100 ,    50      ,6   ,30 ,     90   ,   270   ,  400  ,   550),
deck_building('Vermont Ave.'  ,      'Light-Green'    , 100  ,   50      ,6   ,30 ,     90    ,  270   ,  400  ,   550), 
deck_building('Connecticut Ave.',    'Light-Green'    , 120   ,  50      ,8   ,40 ,     100   ,  300   ,  450  ,   600),
deck_building('St. Charles Place',   'Violet'         , 140   ,  100      ,10  ,50 ,     150  ,   450  ,   625 ,    750),
deck_building('States Ave.'       ,  'Violet'         , 140   ,  100      ,10  ,50,      150  ,   450  ,   625  ,   750),
deck_building('Virginia Ave.'      , 'Violet'         , 160    , 100      ,12  ,60,      180  ,   500  ,   700  ,   900),
deck_building('St. James Place'     ,'Orange'         , 180    , 100      ,14  ,70,      200  ,   550  ,   750  ,   950),
deck_building('Tennessee Ave.'      ,'Orange'         , 180    , 100      ,14  ,70,      200  ,   550  ,   750  ,   950),
deck_building('New York Ave.'       ,'Orange'        ,  200    , 100     ,16  ,80   ,   220   ,  600   ,  800   ,  1000),
deck_building('Kentucky Ave.'       ,'Red'           , 220     ,150     ,18  ,90   ,   250    , 700    , 875    , 1050),
deck_building('Indiana Ave.'        ,'Red'           ,  220    , 150     ,18  ,90 ,     250   ,  700   ,  875   ,  1050),
deck_building('Illinois Ave.'       ,'Red'           ,  240     ,150     ,20  ,100,     300   ,  750   ,  925   ,  1100),
deck_building('Atlantic Ave.'       ,'Yellow'        ,  260     ,150     ,22  ,110,     330   ,  800  ,   975    , 1150),
deck_building('Ventnor Ave.'        ,'Yellow'        ,  260     ,150     ,22  ,110,     330   ,  800  ,   975   ,  1150),
 deck_building('Marvin Gardens'      ,'Yellow'         , 280     ,150     ,22  ,120,     360   ,  850  ,   1025  ,  1200),
  deck_building('Pacific Ave.'        ,'Dark-Green'   ,   300     ,200     ,26  ,130,     390   ,  900  ,   1100  ,  1275),
deck_building('North Carolina Ave.' ,'Dark-Green'  ,    300     ,200     ,26  ,130,     390   ,  900  ,   1100   , 1275),
deck_building('Pennsylvania Ave.'   ,'Dark-Green' ,     320     ,200     ,28  ,150,     450   ,  1000 ,   1200   , 1400),
deck_building('Park Place'          ,'Dark-Blue' ,      350     ,200     ,35  ,175,     500   ,  1100 ,   1300   , 1500),
deck_building('Boardwalk'           ,'Dark-Blue',       400    , 200     ,50  ,200,     600   ,  1400,    1700   , 2000)]
