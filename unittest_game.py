...
class Game_tests(unittest.TestCase):
    def testGame(self):  
        ...
        self.assertEqual(game.trade_buildings(1,[1],2,'peshko',[23],123),False)
        self.assertEqual(game.trade_buildings(1,[3],1000,'peshko',[0],123),True)
        ...
        self.assertEqual(game.community_chest(game.players[1]),'Advance to Go (collect $200)')
        self.assertEqual(game.current_player, 1)
        ...
        self.assertEqual(game.community_chest(game.players[1]),'Get out of jail free')
        self.assertEqual(game.players[0].player_budget(),563)
        self.assertEqual(game.community_chest(game.players[1]),'It is your birthday Collect $10 from each player')
