...
##Начало на играта
Играта се играе от 2 до 4 играча, като всеки играч  в началото трябва да избере уникално име от 6 до 13 символа и фигурка.
...
* шанс или публична личност - това са карти, от които играча може да спечели 
...
* utility - сграда, която носи само пари от рента(пари които дават другите играчи като отидат върху нея),
...
* квартална сграда - всичко което не е от 1-5 е квартална сграда и тя си има цвят и рента. Рентата се покачва в зависимост от това дали има построени къщи и хотели
...
* Играч купува всички сгради от 1 цвят -> това му дава право да строи къщи (5тата е хотел), но
...
* При стъпване на некупена къща играча има право на търг или да я купи за парите които пише на картата
(търгът почва от 1$ )(*tips:дава шанс по неморален начин да победиш ако сте  2  играча)
