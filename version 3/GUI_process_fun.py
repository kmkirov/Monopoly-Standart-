...
def register_player(game): #testvana
    pygame.init()
...
def trade(game,player_name): #bez karti #testvana
    pygame.init()
    window = pygame.display.set_mode((400, 200), 0, 32)
...
#------------- ==== mourtage ==== ----------
def mourtage(game, player_name): #testvana
    pygame.init()
    window = pygame.display.set_mode((400, 200), 0, 32)
...
#------------- ==== unmourtage ==== ----------
def unmourtage(game, player_name):  #testvana
    pygame.init()
    window = pygame.display.set_mode((400, 200), 0, 32)
...
#----------------=== end unmourtage =======-----------
#------------- ==== build_house ==== ----------
def build_house(game,player_name):   #testvana
    pygame.init()
    window = pygame.display.set_mode((400, 200), 0, 32)
...
#------------- ==== sell_house ==== ----------
def sell_house(game,player_name):   #testvana
    pygame.init()
    window = pygame.display.set_mode((400, 200), 0, 32)
