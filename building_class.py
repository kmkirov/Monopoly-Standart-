class deck_building:
    ...
    def get_price(self):
        return self.self.building_price
    ...
    def take_fee(self):
        if not self.is_mourtaged() and self.owner != 'BANK':
    ...
    def is_mourtaged(sefl):
        return self.is_mourtaged != False

    def can_build(self, player_name):
        return self.owner == player_name and not self.is_mourtaged()
